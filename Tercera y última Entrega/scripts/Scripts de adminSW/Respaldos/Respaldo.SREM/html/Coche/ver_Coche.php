    ...
    <div class="card2">
        <table class="content-table1">
            <thead>
                <tr class="txt4">
                    ...
                    <th class="th" style="background-color: #ACACAD;">Marca</th>
                    <th class="th" style="background-color: #ACACAD;">Modelo</th>
                    <th class="th" style="background-color: #ACACAD;">Cantidad de pasajeros</th>
                    <th class="th" style="background-color: #ACACAD;">Nombre del chofer</th>
                    <th class="th" style="background-color: #ACACAD;">Telefono del chofer</th>
                </tr>
            </thead>
        ...
        <div id="miModal4" class="modal2">
            <div class="modal-content2">
                ...
                <p>Condición de Salud del Chofer: <span id="modalSaludChofer"></span></p>
