...
?>
    ...
    <div id="miModal" class="modal">
        <div class="modal-contenido">
            ...
            <div class="modal-botones">
                <a href="../Man.Coche/ver_ManCoche.php" class="btn5"><button id="Cancelar"
    ...
    <div class="card2">
        <table class="content-table1">
            <thead>
                <tr class="txt4">
                    ...
                    <th class="th" style="background-color: #ACACAD;">Importe</th>
                    <th class="th" style="background-color: #ACACAD;">Concepto</th>
                </tr>
            </thead>
            <tbody id="data"></tbody>
        </table>
        ...
        <div id="miModal4" class="modal2">
            <div class="modal-content2">
                ...
                <p>Importe: <span id="modalImporte"></span></p>
                <p>Concepto: <span id="modalConcepto"></span></p>
    ...
    <script type="text/javascript" src="Man.Coche.js"></script>
