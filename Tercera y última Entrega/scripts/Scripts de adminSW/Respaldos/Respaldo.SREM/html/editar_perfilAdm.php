                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-op1">
                            ...
                            <div id="buttonContainer2" class="hidden2">
                                <a href="Cliente/ver_Cliente.php" class="dropdown-op">Ver</a>
                                <a href="Cliente/agregarCliente.php" class="dropdown-op">Agregar</a>
                            </div>
                        </li>
                        <li class="dropdown-op1">
        ...
        <div class="card1">
            <form method="post" action="edtPerfil.php">
                ...
                <p class="txt1">
                    ...
                    <br><br><br><br><br>
                    <button type="sumbit" class="btn6"  title="Editar"> Editar usuario</button>
                </p>
            </form>
        </div>
    </div>
