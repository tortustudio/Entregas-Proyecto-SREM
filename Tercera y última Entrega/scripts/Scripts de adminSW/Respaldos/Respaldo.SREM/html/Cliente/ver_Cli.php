...
?>
    ...
    <div class="card2">
        <table class="content-table">
            <thead>
                <tr class="txt4">
                    <th class="th" style="background-color: #ACACAD;">RUT</th>
                    <th class="th" style="background-color: #ACACAD;">Nombre ficticio</th>
                    <th class="th" style="background-color: #ACACAD;">Razon social</th>
                    <th class="th" style="background-color: #ACACAD;">Teléfono</th>
                    <th class="th" style="background-color: #ACACAD;">Dirección</th>
                    <th class="th" style="background-color: #ACACAD;">Lista <br> negra</th>
                </tr>
            </thead>
            <tbody id="data"></tbody>
        </table>
        <br>
        <a href="agregarCli.php" style="text-decoration: none; color: black;" ><button class="btn12">Agregar un cliente </button></a>
